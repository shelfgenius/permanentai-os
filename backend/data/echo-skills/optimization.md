...
name: optimization
id: optimize
description: Use when improving performance, latency, throughput, memory usage, or general efficiency. Define target metrics, measure comprehensively, attribute bottlenecks, and prioritize macro-optimizations before micro-optimizations.
---
